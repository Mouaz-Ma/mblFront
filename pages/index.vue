<template>
  <v-app>
    <nav-bar :allMailsData=allMailsData />
      <section id="hero">
        <v-row no-gutters>
          <v-img
      ...
      <section id="about-me">
        ...
        <v-container class="text-center">
          <h2 class="display-2 font-weight-bold mb-3">ABOUT THE ASSIGNMENT</h2>
          ...
          >
           ...
           The Project stack: 
           <ul>
             <li>DB: mongoDb hosted on mongo Atlas</li>
             <li>API: nodejs hosted on heroku</li>
             <li>FrontEnd: Nuxtjs hosted on heroku as well</li>
             used Vuetify as UI lib
           </ul>
           I implemented authentication for the purpose to check the user logged in, only<br>
            user name : jim<br>
            password : 123123 <br>
            will have emails in the inbox.<br>
            regarding emails its full CRUD. you can check the github repo but i didn't implement create update or delete in the frontEnd since it wasn't asked for but the endpoint are working fine.
            and Only jim can access the emails and since it's written in the assignemnt that a predefind user will be able to read the mail i didn't make relationships between emails and users.
            if needed let me know and i can make it.
            </span>
          </v-responsive>
<a href="https://www.linkedin.com/in/mouaz-m-589599113/">
          <v-avatar
            class="elevation-12 mb-12"
            size="128"
          >
             <v-img src="https://media-exp1.licdn.com/dms/image/C4D03AQGpH4h71jSd_w/profile-displayphoto-shrink_100_100/0/1581328350888?e=1659571200&v=beta&t=B_m41b0si4wmuY9CaRlBnPGd4FuiaD7DljmgH1qPIpU"></v-img>
          </v-avatar>
             </a>
          ...
          <v-btn
            color="grey"
            href="https://github.com/Mouaz-Ma/mblFront"
            outlined
            large
          >
            <span class="grey--text text--darken-1 font-weight-bold">
              Github Repo for the frontEnd
                    ...
                    <v-btn
            color="black"
            href="https://github.com/Mouaz-Ma/mblhomeassesment"
            outlined
            large
          >
            <span class="grey--text text--darken-1 font-weight-bold">
...
export default {
  ...
  name: 'IndexPage',
   data () {
      ...
      try {
        const allMails = $axios.get('/api/email/')
        const allMailPromise = await Promise.resolve(allMails)
        const allMailsData = allMailPromise.data.noE
        return {
          allMailsData
        }
      } catch (err) {
